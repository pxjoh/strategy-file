    ...
    <article className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 space-y-3">
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-semibold text-sm leading-tight">{tweet.author.name}</p>
            <p className="text-zinc-400 text-sm">@{tweet.author.handle}</p>
          </div>
        </div>
        <span className="text-zinc-500 text-sm flex-shrink-0">{timeAgo(tweet.created_at)}</span>
      </div>
      ...
      <div className="flex items-center gap-5 text-zinc-400 text-sm pt-1">
        ...
        <span title="Replies" className="flex items-center gap-1.5">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <span title="Retweets" className="flex items-center gap-1.5">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
